...
lv_bar_set_value(ui_mainProgressBar,0,LV_ANIM_OFF);
...
lv_label_set_text(ui_mainProgressLbl,"0:00");
...
lv_label_set_text(ui_mainSongLenLbl,"0:00");
...
lv_label_set_text(ui_mainSongLbl,"{Song Name}");
...
lv_label_set_text(ui_mainArtistLbl,"{Artist Name}");
...
lv_label_set_text(ui_mainContextLbl,"{Context Name}");
